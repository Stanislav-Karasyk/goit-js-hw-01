  ...
  return (strOne, strTwo, indexI, counter1, counter2, indexJ) => {
    ...
    if (result === undefined) {
      ...
      if (indexI < wordOne.length) {
        ...
        return memoAnagram(strOne, strTwo, ++indexI, counter1, counter2);
      }
  ...
  return (number, array, index) => {
    ...
    if (result === undefined) {
      ...
      if (index < array.length) {
        ...
        result = resultNum + memoConvertBinaryToDecimal(number, array, ++index);
        memo[key] = result;
  ...
  return (matrix1, matrix2, resultMatrix, indexI, indexJ, indexK) => {
    ...
    if (result === undefined) {
      ...
      if (indexI < matrix1.length) {
        ...
        return memoMatrixAddition(matrix1, matrix2, resultMatrix, ++indexI);
      }
